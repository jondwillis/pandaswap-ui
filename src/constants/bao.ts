...
const tokenMap = {
  ...
  PNDA: new TokenDescriptor('0x47DcC83a14aD53Ed1f13d3CaE8AA4115f07557C0', '', 18),
  BUSD: new TokenDescriptor('0xe9e7cea3dedca5984780bafc599bd69add087d56', '', 18),
  ETH: new TokenDescriptor('0x2170ed0880ac9a755fd29b2688956bd959f933f8', '', 18),
  USDC: new TokenDescriptor('0x8ac76a51cc950d9822d68b83fe1ad97b32cd580d', '', 18),
  DAI: new TokenDescriptor('0x1af3f329e8be154074d8769d1ffa4ee058b1dbc3', '', 18),
  CAKE: new TokenDescriptor('0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82', '', 18),
  ADA: new TokenDescriptor('0x3ee2200efb3400fabb9aacf31297cbdd1d435d47', '', 18),
  DOT: new TokenDescriptor('0x7083609fce4d1d8dc0c979aab8c869ea2c873402', '', 18),
  ...
  UNI: new TokenDescriptor('0xbf5140a22578168fd562dccf235e5d43a02ce9b1', '', 18),
  ...
  VAI: new TokenDescriptor('0x4bd17003473389a42daf6a0a729f6fdb328bbbd7', '', 18),
...
export const supportedPools: SupportedPool[] = [
  ...
  },
  {
    ...
    tokenAddresses: {
      56: [tokenMap.vUSDT, tokenMap.BUSD],
    },
    tokenDecimals: 18,
    name: 'USDT-BUSD',
  ...
  },
  {
    ...
    tokenAddresses: {
      56: [tokenMap.BUNNY, tokenMap.BNB],
    },
    tokenDecimals: 18,
    name: 'Bunny Bacon',
  ...
  },
  {
    ...
    tokenAddresses: {
      56: [tokenMap.vUSDC, tokenMap.BUSD],
    },
    tokenDecimals: 18,
    name: 'USDC Crunch',
