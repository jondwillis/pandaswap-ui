...
import { TokenAmount, Token, ChainId, Percent, JSBI } from 'uniswap-bsc-sdk'
...
describe('utils', () => {
  describe('#getEtherscanLink', () => {
    ...
    it('enum', () => {
      expect(getEtherscanLink(ChainId.RINKEBY, 'abc', 'address')).toEqual('https://rinkeby.bscscan.io/address/abc')
    })
  })
