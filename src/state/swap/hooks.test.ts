    ...
    test('BNB to DAI', () => {
      expect(
        queryParametersToSwapState(
          parse(
            '?inputCurrency=BNB&outputCurrency=0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c&exactAmount=20.5&exactField=outPUT',
            { parseArrays: false, ignoreQueryPrefix: true }
          )
        )
      ).toEqual({
        [Field.OUTPUT]: { currencyId: '0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c' },
